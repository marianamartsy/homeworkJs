...
if (isNaN(lengthA) || isNaN(lengthB) || isNaN(lengthC) || lengthA <= 0 || lengthB <= 0 || lengthC <= 0 || a + b <= c || b + c <= a || a + c <= b) {
	...
	if (
		Math.pow(lengthA, 2) === Math.pow(lengthB, 2) + Math.pow(lengthC, 2) ||
		Math.pow(lengthB, 2) === Math.pow(lengthA, 2) + Math.pow(lengthC, 2) ||
